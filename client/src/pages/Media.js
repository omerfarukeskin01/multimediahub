...
function Media(props) {
  ...
  return (
    ...
    <div class="card">
  <div class="icons"> 
              <button class="save" onClick={sendDataToCreatPost}>
    ...
    <div class="imgbox">
        <div class="img">
        <img src={props.MediaImages} alt="test" className="imagesize" />
        </div>
    </div>
    <div class="details">
        <h2 class="title">{props.MediaNametext}</h2>
        <span class="caption">{props.MediaType}</span>
    </div>
</div>
